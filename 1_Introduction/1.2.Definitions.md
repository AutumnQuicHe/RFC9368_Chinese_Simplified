...
如果版本协商跨越多个连接（详见[第2.4章](#2.4_Connections_and_Version_Negotiation)），初始版本等于第一个QUIC连接的客户端选择版本。
...
注意，这里的“段（segment）”概念源自《[TCP](#TCP)》[第3.4.1章](https://www.rfc-editor.org/rfc/rfc9293.html#name-initial-sequence-number-sel)。
